...
export class RootsToken__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class RootsToken extends ethereum.SmartContract {
  static bind(address: Address): RootsToken {
    return new RootsToken("RootsToken", address);
  }

  AIRDROP_ALLOCATION(): BigInt {
  ...
  try_AIRDROP_ALLOCATION(): ethereum.CallResult<BigInt> {
  ...
  AMBASSADOR_ALLOCATION(): BigInt {
    let result = super.call(
      "AMBASSADOR_ALLOCATION",
      "AMBASSADOR_ALLOCATION():(uint256)",
      [],
    );
  ...
  try_AMBASSADOR_ALLOCATION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "AMBASSADOR_ALLOCATION",
      "AMBASSADOR_ALLOCATION():(uint256)",
      [],
  ...
  FOUNDER_ALLOCATION(): BigInt {
    let result = super.call(
      "FOUNDER_ALLOCATION",
      "FOUNDER_ALLOCATION():(uint256)",
      [],
    );
  ...
  try_FOUNDER_ALLOCATION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "FOUNDER_ALLOCATION",
      "FOUNDER_ALLOCATION():(uint256)",
      [],
  ...
  try_LIQUIDITY_ALLOCATION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "LIQUIDITY_ALLOCATION",
      "LIQUIDITY_ALLOCATION():(uint256)",
      [],
  ...
  try_TREASURY_ALLOCATION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "TREASURY_ALLOCATION",
      "TREASURY_ALLOCATION():(uint256)",
      [],
  ...
  airdrop(): Address {
    let result = super.call("airdrop", "airdrop():(address)", []);

    return result[0].toAddress();
  }

  try_airdrop(): ethereum.CallResult<Address> {
    let result = super.tryCall("airdrop", "airdrop():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  eip712Domain(): RootsToken__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new RootsToken__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<RootsToken__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new RootsToken__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  founderVesting(): Address {
    let result = super.call("founderVesting", "founderVesting():(address)", []);

    return result[0].toAddress();
  }

  try_founderVesting(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "founderVesting",
      "founderVesting():(address)",
      [],
